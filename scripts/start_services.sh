...
# Log startup
cd "$BASE_DIR"
echo "Starting A1 Voiceflow Services at $(date) in BASE_DIR: ${BASE_DIR}"
...
NGINX_UPSTREAM_TEMPLATE="$BASE_DIR/nginx/a1-voiceflow_upstream.conf.template"
NGINX_UPSTREAM_CONF="/etc/nginx/conf.d/a1-voiceflow_upstream.conf"
