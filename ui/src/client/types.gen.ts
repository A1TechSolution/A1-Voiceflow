...
export type ClientOptions = {
    baseUrl: 'https://voiceflow.a1techsolution.com' | 'http://localhost:8000' | (string & {});
};
...
export type AriConfigurationRequest = {
     ...
     * Ws Client Name
     *
     * websocket_client.conf connection name for externalMedia (e.g., a1-voiceflow_staging)
     */
...
export type CurrentUsageResponse = {
    ...
    period_end: string;
    /**
     * Used A1 Voiceflow Tokens
     */
    used_a1-voiceflow_tokens: number;
    /**
     * Quota A1 Voiceflow Tokens
     */
    quota_a1-voiceflow_tokens: number;
    /**
     * Percentage Used
     */
...
export type DailyUsageBreakdownResponse = {
    ...
    /**
     * Total A1 Voiceflow Tokens
     */
    total_a1-voiceflow_tokens: number;
    /**
     * Currency
     */
    currency?: string | null;
...
export type HttpApiConfig = {
     ...
     * Preset Parameters
     *
     * Parameters injected by A1 Voiceflow from fixed values or workflow context templates
     */
...
export type GetVoicesApiV1UserConfigurationsVoicesProviderGetData = {
    ...
    path: {
         ...
         * Provider
         */
        provider: 'elevenlabs' | 'deepgram' | 'sarvam' | 'cartesia' | 'a1-voiceflow' | 'rime';
    };
    query?: {
        /**
         * Model
