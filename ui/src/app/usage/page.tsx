    ...
    return (
        <div className="container mx-auto p-6 space-y-6">
            <div>
                ...
                <Card className="mb-6">
                    <CardHeader>
                        <CardTitle>A1 Voiceflow Model Credits</CardTitle>
                        <CardDescription>
                            These track usage of A1 Voiceflow models using A1 Voiceflow Service Keys.
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        {isLoadingCredits ? (
                            ...
                            <p className="text-muted-foreground">No A1 Voiceflow service keys configured. Set up a service key in your model configuration to see usage.</p>
                        )}
                    </CardContent>
                </Card>
                                                ...
                                                >
                                                    ...
                                                    <TableCell className="text-right font-medium">
                                                        {organizationPricing?.price_per_second_usd && run.charge_usd !== undefined && run.charge_usd !== null
                                                            ...
                                                            : run.a1-voiceflow_token_usage.toLocaleString()
                                                        }
                                                    </TableCell>
                                                    <TableCell>
                                                        <MediaPreviewButton
                                    ...
                                    <div className="mt-4 p-3 bg-muted rounded-md">
                                        <p className="text-sm text-muted-foreground">
                                            Total for filtered period: <span className="font-semibold text-foreground">
                                                {usageHistory.total_a1-voiceflow_tokens.toLocaleString()} A1 Voiceflow Tokens
                                            </span>
                                            {' • '}
