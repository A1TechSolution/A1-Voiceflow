...
export async function impersonateAsSuperadmin(params: {
  ...
  // (served from the target sub-domain, e.g. voiceflow.a1techsolution.com). The route will set the
  ...
  // superadmin.a1techsolution.com we want to switch to voiceflow.a1techsolution.com. For any other domain
