  ...
  return (
    <header className="sticky top-0 z-50 flex items-center justify-between border-b bg-background px-4 py-2">
      <div className="flex items-center gap-3">
        ...
        <Link href="/" className="text-lg font-bold md:hidden">A1 Voiceflow</Link>
      </div>
      <div className="flex items-center gap-3">
        <Button variant="ghost" size="sm" asChild>
          <a
            href="https://join.slack.com/t/a1-voiceflow-community/shared_invite/zt-3czr47sw5-MSg1J0kJ7IMPOCHF~03auQ"
            target="_blank"
