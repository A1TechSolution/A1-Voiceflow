...
def _make_service() -> A1 VoiceflowGrokRealtimeLLMService:
    service = A1 VoiceflowGrokRealtimeLLMService(api_key="test-key")
...
def test_factory_creates_a1-voiceflow_grok_realtime_service():
    ...
    assert isinstance(service, A1 VoiceflowGrokRealtimeLLMService)
