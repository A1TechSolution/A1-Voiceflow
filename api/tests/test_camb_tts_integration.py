"""Tests for CAMB AI TTS integration into A1 Voiceflow.
...
class TestServiceFactoryCamb:
    def test_create_tts_service_camb(self):
        ...
        a1-voiceflow_modules = [
            "pipecat.services.a1-voiceflow",
            "pipecat.services.a1-voiceflow.llm",
            "pipecat.services.a1-voiceflow.stt",
            "pipecat.services.a1-voiceflow.tts",
            "pipecat.utils.text.xml_function_tag_filter",
        ]
        mocks = {}
        for mod in a1-voiceflow_modules:
