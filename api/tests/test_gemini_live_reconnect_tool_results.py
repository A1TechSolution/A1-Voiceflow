...
class _TestA1 VoiceflowGeminiLiveLLMService(A1 VoiceflowGeminiLiveLLMService):
    """A1 Voiceflow Gemini service with client creation stubbed for unit tests."""
...
def _make_service() -> _TestA1 VoiceflowGeminiLiveLLMService:
    service = _TestA1 VoiceflowGeminiLiveLLMService(api_key="test-key")
