"""Tests for the Python runtime SDK (`a1_voiceflow_sdk`).
...
import pytest
from a1_voiceflow_sdk import Workflow
from a1_voiceflow_sdk._generated_models import NodeSpec
from a1_voiceflow_sdk.errors import ValidationError
...
class _StubClient:
    """Stand-in for A1 VoiceflowClient backed by the in-process spec registry.
...
def test_webhook_complex_fields_validate(client: _StubClient):
    ...
    wh = wf.add(
        ...
        custom_headers=[{"key": "X-Source", "value": "a1-voiceflow"}],
