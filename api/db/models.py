...
class OrganizationModel(Base):
    ...
    quota_a1-voiceflow_tokens = Column(
...
class OrganizationUsageCycleModel(Base):
    """
    This model is used to track the usage of A1 Voiceflow tokens for an organization for a given usage
    cycle.
    """
    ...
    quota_a1-voiceflow_tokens = Column(Integer, nullable=False)
    used_a1-voiceflow_tokens = Column(Float, nullable=False, default=0)
