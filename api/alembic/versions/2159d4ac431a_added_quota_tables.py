...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("quota_a1-voiceflow_tokens", sa.Integer(), nullable=False),
        sa.Column("used_a1-voiceflow_tokens", sa.Integer(), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_column("organizations", "quota_a1-voiceflow_tokens")
