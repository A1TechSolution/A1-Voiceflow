"""A1 Voiceflow subclass of pipecat's Grok Realtime LLM service.
...
- **finalized=True on TranscriptionFrame** for parity with A1 Voiceflow's other
  realtime providers.
"""
...
class A1 VoiceflowGrokRealtimeLLMService(GrokRealtimeLLMService):
    """Grok Realtime with A1 Voiceflow engine integration quirks."""
