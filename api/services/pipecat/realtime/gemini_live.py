"""A1 Voiceflow subclass of pipecat's Gemini Live LLM service.
...
class A1 VoiceflowGeminiLiveLLMService(GeminiLiveLLMService):
    """Gemini Live with A1 Voiceflow engine integration quirks. See module docstring."""
    ...
    # ------------------------------------------------------------------
    # Context lifecycle: A1 Voiceflow pre-populates self._context via the engine,
    ...
    # init-instruction reconciliation (A1 Voiceflow updates system_instruction at
    ...
    # kick off bot turns in the A1 Voiceflow flow.
    # ------------------------------------------------------------------
