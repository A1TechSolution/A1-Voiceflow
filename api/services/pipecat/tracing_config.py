...
class _OrgAttributeSpanProcessor(SpanProcessor):
    ...
    def on_start(self, span, parent_context=None):
        ...
        if org_id:
            span.set_attribute("a1-voiceflow.org_id", str(org_id))
...
class _OrgRoutingExporter(SpanExporter):
    ...
    Spans with a ``a1-voiceflow.org_id`` attribute whose org has registered
    ...
    def export(self, spans):
        ...
        for span in spans:
            ...
            org_id = span.attributes.get("a1-voiceflow.org_id") if span.attributes else None
...
def ensure_tracing() -> bool:
    ...
    setup_tracing(service_name="a1-voiceflow-pipeline", exporter=_org_routing_exporter)
