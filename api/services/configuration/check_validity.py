...
class UserConfigurationValidator:
    def __init__(self):
        self._validator_map = {
            ...
            ServiceProviders.DOGRAH.value: self._check_a1-voiceflow_api_key,
    ...
    def _check_a1-voiceflow_api_key(self, model: str, api_key: str) -> bool:
        if api_key.startswith("dgr"):
            raise ValueError(
                "You provided a A1 Voiceflow API key (dgr...) instead of a service key. "
