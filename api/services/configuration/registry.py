...
DOGRAH_PROVIDER_MODEL_CONFIG = provider_model_config("A1 Voiceflow")
...
@register_llm
class A1 VoiceflowLLMService(BaseLLMConfiguration):
    model_config = DOGRAH_PROVIDER_MODEL_CONFIG
    provider: Literal[ServiceProviders.DOGRAH] = ServiceProviders.DOGRAH
    model: str = Field(
        default="default",
        description="A1 Voiceflow-hosted model tier.",
...
class GoogleTTSConfiguration(BaseTTSConfiguration):
    ...
    model: str = Field(
        default="chirp_3_hd",
        description=(
            "Google Cloud low-latency TTS engine. A1 Voiceflow maps this to Pipecat's "
...
@register_tts
class A1 VoiceflowTTSService(BaseTTSConfiguration):
    model_config = DOGRAH_PROVIDER_MODEL_CONFIG
    provider: Literal[ServiceProviders.DOGRAH] = ServiceProviders.DOGRAH
    model: str = Field(
        default="default",
        description="A1 Voiceflow TTS tier.",
...
# A1 Voiceflow STT Service
DOGRAH_STT_MODELS = ["default"]
DOGRAH_STT_LANGUAGES = DEEPGRAM_LANGUAGES


@register_stt
class A1 VoiceflowSTTService(BaseSTTConfiguration):
    model_config = DOGRAH_PROVIDER_MODEL_CONFIG
    provider: Literal[ServiceProviders.DOGRAH] = ServiceProviders.DOGRAH
    model: str = Field(
        default="default",
        description="A1 Voiceflow STT tier.",
