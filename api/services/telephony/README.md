...
This module implements the telephony provider abstraction for A1 Voiceflow. For user-facing documentation, see the [Mintlify docs](https://voiceflow-docs.a1techsolution.com/integrations/telephony/overview).
...
See the [Custom Provider Guide](https://voiceflow-docs.a1techsolution.com/integrations/telephony/custom) in the documentation for detailed implementation instructions.
...
- [User Documentation](https://voiceflow-docs.a1techsolution.com/integrations/telephony/overview)
- [Twilio Integration](https://voiceflow-docs.a1techsolution.com/integrations/telephony/twilio)
- [Custom Providers](https://voiceflow-docs.a1techsolution.com/integrations/telephony/custom)
- [Webhooks Guide](https://voiceflow-docs.a1techsolution.com/integrations/telephony/webhooks)
