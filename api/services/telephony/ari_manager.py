...
from api.services.quota_service import check_a1-voiceflow_quota_by_user_id
...
class ARIConnection:
    ...
    async def _create_external_media(
        ...
        # e.g. wss://api.a1techsolution.com/ws/ari?workflow_id=1&user_id=2&workflow_run_id=3
        transport_data = (
    ...
    async def _handle_inbound_stasis_start(
        ...
        try:
            ...
            quota_result = await check_a1-voiceflow_quota_by_user_id(
    ...
    async def _handle_stasis_start(
        ...
        """
        ext_channel_id = f"a1-voiceflow-ext-{uuid.uuid4()}"
        try:
            logger.info(
