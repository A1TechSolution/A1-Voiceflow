...
class TelnyxProvider(TelephonyProvider):
    ...
    async def initiate_call(
        ...
        **kwargs: Any,
        ...
        # stream_bidirectional_codec controls only the A1 Voiceflow → Telnyx direction.
        # The Telnyx → A1 Voiceflow direction follows the PSTN leg and is announced via
    ...
    async def handle_websocket(
        ...
        try:
            ...
            # inbound direction (Telnyx → A1 Voiceflow); the outbound direction is
