...
Usage:
    ...
    python -m evals.stt.benchmark audio/multi_speaker.m4a --diarize --keyterms "A1 Voiceflow" "Pipecat"
"""
...
Examples:
  python -m evals.stt.benchmark audio/multi_speaker.m4a --diarize
  python -m evals.stt.benchmark audio/multi_speaker.m4a --diarize --providers deepgram
  python -m evals.stt.benchmark audio/multi_speaker.m4a --keyterms "A1 Voiceflow" "API"
        """,
    )
    parser.add_argument(
        "audio_file",
