...
Typed builder for A1 Voiceflow voice-AI workflows. Fetches the node-spec catalog from
the A1 Voiceflow backend at session start, validates every call against it at the
...
{
  "paths": {
    "@a1-voiceflow/sdk": ["../sdk/typescript/src/index.ts"]
  }
}
```
