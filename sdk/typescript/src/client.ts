// HTTP client for the A1 Voiceflow REST API.
//
...
export interface A1 VoiceflowClientOptions {
    baseUrl?: string;
    apiKey?: string;
...
export class A1 VoiceflowClient extends _GeneratedClient implements SpecProvider {
    ...
    constructor(opts: A1 VoiceflowClientOptions = {}) {
        super();
        const rawBase =
            opts.baseUrl ??
