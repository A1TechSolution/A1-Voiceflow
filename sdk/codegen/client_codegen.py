...
Output:
    --py-out  sdk/python/src/a1_voiceflow_sdk/_generated_client.py
...
`A1 VoiceflowClient` mixes in this class to get HTTP methods for every route
...
from a1_voiceflow_sdk._generated_models import (
{imports}
)


class _GeneratedClient:
    # `A1 VoiceflowClient.__init__` installs `self._request` (see client.py).
...
// Regenerate with `./scripts/generate_sdk.sh`.
//
// `A1 VoiceflowClient` extends this base to get HTTP methods for every route
