...
from a1_voiceflow_sdk import A1 VoiceflowClient
from a1_voiceflow_sdk._generated_models import CreateWorkflowRequest
...
# Open the new agent in the A1 Voiceflow UI to extend it, or edit this dict and
...
def main() -> int:
    ...
    with A1 VoiceflowClient(base_url=api_endpoint, api_key=api_token) as client:
